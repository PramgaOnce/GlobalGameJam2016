...
/////// Diffuse:
                ...
                float4 node_650 = _Time + _TimeEditor;
                float2 node_9358 = (i.uv0+node_650.g*float2(0.25,0));
                float2 node_4068 = (node_9358 + float2(node_4068_tx, node_4068_ty)) * node_4068_tc_rcp;
...
/////// Diffuse:
                ...
                float2 node_9358 = (i.uv0+node_747.g*float2(0.25,0));
                float2 node_4068 = (node_9358 + float2(node_4068_tx, node_4068_ty)) * node_4068_tc_rcp;
                float4 _GradientPanner_var = tex2D(_GradientPanner,TRANSFORM_TEX(node_4068, _GradientPanner));
                float4 node_8601 = _Time + _TimeEditor;
                float node_3958 = sin((_PulseSpeed*node_8601.g));
